  ...
  Future<void> signInAnonymously() async {
    ...
    if (uid == null) {
      try {
        ...
        signUpWithCustomUID(uid);
      } catch (e) {
        print('An error occurred while signing in anonymously: $e');
      }
    } else {
    }
  }

  Future<void> signInWithCustomUID() async {
    ...
    if (userCredential.user?.displayName == uid) {
      ...
      print('Geçersiz özel kimlik');
    }
  }

  Future<void> signUpWithCustomUID(String customUID) async {
    ...
    await userCredential.user?.updateDisplayName(customUID);
                          ...
                          child: Padding(
                            ...
                            child: ElevatedButton(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(child: Text('easylogin'.tr)),
                                    Icon(Icons.login),
                                  ],
                                ),
                                onPressed: (){
                          ...
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Row(
                                ...
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  Expanded(child: Text('easyregister'.tr)),
                                  Icon(Icons.person_add),
                                ],
                              ),
                              onPressed: () async {
